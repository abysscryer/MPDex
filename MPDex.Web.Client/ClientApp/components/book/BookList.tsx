...
import { ICoin, BookType, IBook } from "./BookListType";
...
export class BookList extends React.Component<RouteComponentProps<{}>, BookListState>{
    constructor() {
        ...
        this.state = {
            ...
            hubConnection: new HubConnection('http://localhost:5001/book')
        }
    }
    ...
    private addBook = (book: IBook): void => {
        ...
        if (book.bookType == BookType.Buy) {
            ...
            if (index >= 0) {
                ...
                this.setState({
                    buys: this.state.buys.sort((a: IBook, b: IBook) => {
            ...
            if (index >= 0) {
                ...
                this.setState({
                    sells: this.state.sells.sort((a: IBook, b: IBook) => {
                        return b.price - a.price;
                    })
                });
            }
        ...
        fetch(`http://localhost:5002/api/book?booktype=${bookType}&currencyId=${currencyId}&coinId=${coinId}`, {
            ...
            .then(data => {
                if (bookType === BookType.Buy) {
                    this.setState({
                        buys: data.sort((a: IBook, b: IBook) => {
                            return b.price - a.price;
                        }).slice(0, 5)
                    });
                }
                    ...
                    this.setState({
                        sells: data.sort((a: IBook, b: IBook) => {
                            return b.price - a.price;
                        }).slice(5)
                    });
                }
